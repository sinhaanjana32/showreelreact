  ...
  useEffect(() => {
    ...
    function treeMap(flare) {
      return new Promise((resolve) => {
        ...
        cell
          .transition()
          .duration((d, i) => Math.random() * (1000 - 500) + 500)
    ...
    function circlePack(flare) {
      return new Promise((resolve) => {
        var pack = d3.pack().size([width, height]).padding(2.5);
        var root = d3
          .hierarchy(flare)
          .sum((d) => d.size)
      ...
      return new Promise((resolve) => {
        ...
        function showLinks() {
          ...
          svg
            ...
            .attr(
              "stroke-dasharray",
              (d, i) => pathLengths[i] + " " + pathLengths[i]
            )
    ...
    function endShowreel() {
      return new Promise((resolve) => {
        svg
          ...
          .attr(
            "transform",
            `translate(${width / 2},${height / 2})scale(0.01)rotate(180)`
          )
          .style("opacity", 0)
          .on("end", () => {
            svg
